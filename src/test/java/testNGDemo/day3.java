...
@Test(timeOut=4000)
// test case will wait for 40 sec to fail
public void MobileTimeLoan()
{
	System.out.println("test case will wait for 40 sec");
}
	@BeforeMethod
	...
	@BeforeSuite
	// Before Suite execute at the first of Project.
	public void Bfsuite()
	{
		System.out.println(" I am no 1");
	}
	@Test(enabled=false)
	//it will skip the test case
